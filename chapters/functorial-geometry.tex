...
\NewDocumentCommand\Units{}{\mathbb{G}_{\mathsf{m}}}
\NewDocumentCommand\AffLine{}{\mathbb{A}^1}
\NewDocumentCommand\ZZ{}{\mathbb{Z}}

\begin{para}[The affine line]
  %
...
%
  Hence, in the logos $\FunPreSp$ of presheaves, one may speak of the \emph{affine line}
