...
\begin{para}\label{para:prime-ideal-localization}
  ...
  A\brk{\Inv*{A\setminus\frk{a}}}$ (which is a local ring).
\end{para}
...
\begin{para}
  ...
  ring $A$ is then classifying topos of prime ideals of $A$.
\end{para}

\begin{para}
  Accordingly, we form underlying space of the \emph{spectrum} of a ring as the following pullback:
  \[
    \DiagramSquare{
      nw/style = pullback,
      nw = \Spec{A},
