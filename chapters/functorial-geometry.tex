...
\begin{para}\label{para:generating-local-cover-to-sieve}
  %
...
\begin{para}
  ...
  use the orthogonality condition of \cref{para:functorial-space}, which takes
  a covering sieve as input.

  We choose the covering sieve $U = S_{\brc{a_i}}$ from
  \cref{para:generating-local-cover-to-sieve}, defining an element
  ...
  \cref{para:functorial-space}, we have a morphism $\Mor{\Yo{A}}{X}$ uniquely
